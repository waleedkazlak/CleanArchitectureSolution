...
namespace CleanSample.Infrastructure.Migrations
{
    ...
    [Migration("20260910132915_RemoveLoadRequestPartIdAndRenameLoadsToVehicleLoads")]
    partial class RemoveLoadRequestPartIdAndRenameLoadsToVehicleLoads
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanSample.Domain.Entities.VehicleOffloadItem", b =>
                {
                    b.HasOne("CleanSample.Domain.Entities.Load", "Load")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_VehicleOffloadItems_VehicleLoads");
