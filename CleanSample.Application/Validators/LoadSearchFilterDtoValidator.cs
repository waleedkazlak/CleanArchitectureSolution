...
public class LoadSearchFilterDtoValidator : AbstractValidator<LoadSearchFilterDto>
{
    ...
    public LoadSearchFilterDtoValidator()
    {
        ...
        RuleFor(x => x.LoadRequestPartId)
            .GreaterThan(0).WithMessage("Load request part ID must be greater than 0")
            .When(x => x.LoadRequestPartId.HasValue);
