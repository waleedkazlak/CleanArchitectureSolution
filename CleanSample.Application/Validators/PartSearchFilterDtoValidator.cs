...
public class PartSearchFilterDtoValidator : AbstractValidator<PartSearchFilterDto>
{
    private readonly string[] _validSortFields = { "Code", "Name", "Barcode", "CreatedAt" };
    private readonly string[] _validSortDirections = { "asc", "desc" };

    public PartSearchFilterDtoValidator()
    {
