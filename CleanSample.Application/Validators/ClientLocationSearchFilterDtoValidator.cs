...
public class ClientLocationSearchFilterDtoValidator : AbstractValidator<ClientLocationSearchFilterDto>
{
    private readonly string[] _validSortFields = { "Name", "ClientId", "City", "CreatedAt" };
    private readonly string[] _validSortDirections = { "asc", "desc" };

    public ClientLocationSearchFilterDtoValidator()
    {
