...
public class ColorSearchFilterDtoValidator : AbstractValidator<ColorSearchFilterDto>
{
    private readonly string[] _validSortFields = { "Name", "Code", "CreatedAt" };
    private readonly string[] _validSortDirections = { "asc", "desc" };

    public ColorSearchFilterDtoValidator()
    {
