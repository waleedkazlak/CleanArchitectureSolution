...
public class UpdatePickRequestCommandValidator : AbstractValidator<UpdatePickRequestCommand>
{
    public UpdatePickRequestCommandValidator()
    {
        RuleFor(x => x.Id)
            .GreaterThan(0).WithMessage("PickRequest ID must be greater than 0.");
        ...
        RuleForEach(x => x.PickRequestLines).ChildRules(line =>
        {
